...
var (
        ...
        maxResults    = flag.Int64("maxResults", 9999999999, "The maximum number of playlist resources to include in the API response.")
...
// func videoGet() *youtube.VideoResponse { 
// }
